...
wait $pids
../anserini-lsr/target/appassembler/bin/IndexCollection -collection JsonCollection -input data/trec-robust04/splits_psg_${n}/ -index indexes/trec-robust04-${n}-bm25 -generator DefaultLuceneDocumentGenerator -threads 60 -storePositions -storePositions -storeDocvectors -storeRaw
...
ir_measures trec-robust04 runs/trec-robust04_bm25_${n}.trec NDCG@10 R@1000 >> results_robust04_rm3.txt
